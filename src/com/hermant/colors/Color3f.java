...
public class Color3f {
    ...
    public static Color3f interpolate(Color3f a, Color3f b, float factor){
        float _factor = 1.0f - factor;
        return new Color3f(a.red * _factor + b.red * factor, a.green * _factor + b.green * factor, a.blue * _factor + b.blue * factor);
    }
